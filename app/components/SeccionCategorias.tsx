 ...
 * mes en foco. El mockup muestra, dentro de cada categoría expandida, la lista de gastos individuales
 * (comercio, fecha, monto, badge "Inferido") — ese detalle por gasto no está disponible acá:
 * `obtenerFilasDashboard` solo resuelve totales por mes y categoría (Req. 9.1), no filas por gasto. El
 * panel expandido muestra en cambio los dos datos reales que sí llegan por props: el total de la
 * categoría y la señal "sin confirmar" (Req. 9.3, el mismo patrón visual + etiqueta de texto que ya
 * usa `GraficoMensual`) — nunca una fila de gasto inventada.
 */
